...
import callImage from "assets/call-image.webp";
      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Heading as="h3">The Success Rate of IVF</Heading>
            <Text as="p">
              The success rate of IVF will depend on factors such as the
              maternal age, reproductive history, infertility cause, and other
              lifestyle factors. Most of the time, after an initial
              consultation, you will receive an approximate of your chances.
            </Text>
